...
Saved 19043638 tokens to dataset_prepared/TinyStories_val.bin
Tokenizing train split...
Saved 925653391 tokens to dataset_prepared/TinyStories_train.bin
...
DATA_PREP_CACHE_DIR = "data_prepared"
...
def tokenize():
    ...
    for split_name, split_shards in [("val", val_shards), ("train", train_shards)]:
        ...
        split_filename = os.path.join(DATA_PREP_CACHE_DIR, f"TinyStories_{split_name}.bin")
