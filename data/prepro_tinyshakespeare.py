...
The output is written to a newly created dataset_prepared/ folder.
The script prints:

Saved 32768 tokens to dataset_prepared/tiny_shakespeare_val.bin
Saved 305260 tokens to dataset_prepared/tiny_shakespeare_train.bin
...
DATA_PREP_CACHE_DIR = "dataset_prepared"
...
def tokenize():
    ...
    # save to file
    os.makedirs(DATA_PREP_CACHE_DIR, exist_ok=True)
    val_filename = os.path.join(DATA_PREP_CACHE_DIR, "tiny_shakespeare_val.bin")
    train_filename = os.path.join(DATA_PREP_CACHE_DIR, "tiny_shakespeare_train.bin")
